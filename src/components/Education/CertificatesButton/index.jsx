function CertificatesButton({ url, title }) {
  return (
    <a
      href={url}
      target="_blank"
      className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-primary_ transition duration-300 ease-out border-2 border-primary_ rounded group"
    >
